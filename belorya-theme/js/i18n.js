...
const UI = {
  fr: {
    ...
    cart_view: 'Voir mon panier', cart_continue: 'Continuer mes achats',
    cart_page_title: 'Mon <em>panier</em>', cart_summary_title: 'Récapitulatif',
    cart_empty_page: 'Votre panier est vide pour le moment.',
    ...
    cart_promo_min: 'Ce code s’applique dès {min} d’achat.',
  ...
  en: {
    ...
    cart_view: 'View my cart', cart_continue: 'Continue shopping',
    cart_page_title: 'My <em>Cart</em>', cart_summary_title: 'Order Summary',
    cart_empty_page: 'Your cart is empty for now.',
    ...
    cart_promo_min: 'This code applies from {min} of purchase.',
